...
public class ServerLogger {
	 ...
	 * "if (ServerLogger.info) ..." type statements below the set level.
	 */
	...
	/**
	 * Sets the level to ServerLogger. If a version of this class is being used
	...
	static public void add(LogListener log) {
		logger.add(log);
	}
	 ...
	 * Extended and use {@link ServerLogger#logger} set to handle logging
	 * differently.
	 */
