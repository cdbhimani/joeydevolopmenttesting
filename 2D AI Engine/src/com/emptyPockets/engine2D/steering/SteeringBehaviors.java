...
public class SteeringBehaviors {
	...
	public Vector2D calculate(float updateTime) {
		...
		if(useObstacleAvoidance){
			...
			hold.mul(obstacleAvoidanceWeight);
		...
		if (rst.len2() > vehicle.maxForce * vehicle.maxForce) {
//			System.out.println("Remul : "+rst);
			rst.nor();
			rst.mul(vehicle.maxForce);
		}
